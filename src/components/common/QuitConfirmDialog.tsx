// src/components/common/QuitConfirmDialog.tsx
// Confirmation dialog shown when user tries to quit while a timer is running
...
export function QuitConfirmDialog(): JSX.Element {
  ...
  // Listen for quit-requested event from Rust backend
  useEffect(() => {
          ...
          >
            ...
            <div className="mb-6">
              <p className="text-[var(--sl-text-secondary)] mb-3">
                You have an active timer running. Quitting now will lose your unsaved progress.
              </p>
